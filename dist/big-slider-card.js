...
let BigSliderCard = class BigSliderCard extends LitElement {
    constructor() {
        super();
    ...
    _updateColors() {
        ...
        if (this.stateObj) {
            if (this.stateObj.state == 'on') {
                const stateColor = ((_a = this.stateObj.attributes) === null || _a === void 0 ? void 0 : _a.rgb_color) || [255, 255, 255];
                const stateBrightness = ((_b = this.stateObj.attributes) === null || _b === void 0 ? void 0 : _b.brightness) || 255;
                isOn = true;
                if (stateColor) {
