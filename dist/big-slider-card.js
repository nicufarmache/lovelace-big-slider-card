 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,i){const o=e[0];if("."===o){return new M(t,e.slice(1),n).parts}if("@"===o)return[new O(t,e.slice(1),i.eventContext)];if("?"===o)return[new C(t,e.slice(1),n)];return new P(t,e,n).parts}handleTextExpression(t){return new k(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const j=(t,...e)=>new b(t,e,"html",Y)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Nt=0,Et=0,Ot=[],At=0,Dt=!1,Vt=document.createTextNode("");new window.MutationObserver((function(){Dt=!1;const t=Ot.length;for(let e=0;e<t;e++){let t=Ot[e];if(t)try{t()}catch(t){setTimeout(()=>{throw t})}}Ot.splice(0,t),Et+=t})).observe(Vt,{characterData:!0});const $t={after:t=>({run:e=>window.setTimeout(e,t),cancel(t){window.clearTimeout(t)}}),run:(t,e)=>window.setTimeout(t,e),cancel(t){window.clearTimeout(t)}},Yt={run:t=>(Dt||(Dt=!0,Vt.textContent=At++),Ot.push(t),Nt++),cancel(t){const e=t-Et;if(e>=0){if(!Ot[e])throw new Error("invalid async handle: "+t);Ot[e]=null}}};
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
class jt{constructor(){this._asyncModule=null,this._callback=null,this._timer=null}setConfig(t,e){this._asyncModule=t,this._callback=e,this._timer=this._asyncModule.run(()=>{this._timer=null,Rt.delete(this),this._callback()})}cancel(){this.isActive()&&(this._cancelAsync(),Rt.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return null!=this._timer}static debounce(t,e,n){return t instanceof jt?t._cancelAsync():t=new jt,t.setConfig(e,n),t}}let Rt=new Set;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const Ht=!window.ShadyDOM||!window.ShadyDOM.inUse;Boolean(!window.ShadyCSS||window.ShadyCSS.nativeCss),Ht&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const t=new CSSStyleSheet;t.replaceSync("");const e=document.createElement("div");e.attachShadow({mode:"open"}),e.shadowRoot.adoptedStyleSheets=[t],e.shadowRoot.adoptedStyleSheets[0]}catch(t){return!1}})();window.Polymer&&window.Polymer.rootPath||(Ut=document.baseURI||window.location.href).substring(0,Ut.lastIndexOf("/")+1);var Ut;window.Polymer&&window.Polymer.sanitizeDOMValue;let Lt=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1;window.Polymer&&window.Polymer.strictTemplatePolicy,window.Polymer&&window.Polymer.allowTemplateFromDomModule,window.Polymer&&window.Polymer.legacyOptimizations,window.Polymer&&window.Polymer.legacyWarnings,window.Polymer&&window.Polymer.syncInitialRender,window.Polymer&&window.Polymer.legacyUndefined,window.Polymer&&window.Polymer.orderedComputed,window.Polymer&&window.Polymer.removeNestedTemplates,window.Polymer&&window.Polymer.fastDomIf,window.Polymer&&window.Polymer.suppressTemplateNotifications,window.Polymer&&window.Polymer.legacyNoObservedAttributes,window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS;
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
*/ge({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){ce(this.info)},mousedown:function(t){if(!se(t))return;let e=he(t),n=this;ae(this.info,(function(t){se(t)||(ye("up",e,t),ce(n.info))}),(function(t){se(t)&&ye("up",e,t),ce(n.info)})),ye("down",e,t)},touchstart:function(t){ye("down",he(t),t.changedTouches[0],t)},touchend:function(t){ye("up",he(t),t.changedTouches[0],t)}}),ge({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(t){this.moves.length>2&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,ce(this.info)},mousedown:function(t){if(!se(t))return;let e=he(t),n=this,i=function(t){let i=t.clientX,o=t.clientY;we(n.info,i,o)&&(n.info.state=n.info.started?"mouseup"===t.type?"end":"track":"start","start"===n.info.state&&ve("tap"),n.info.addMove({x:i,y:o}),se(t)||(n.info.state="end",ce(n.info)),e&&be(n.info,e,t),n.info.started=!0)};ae(this.info,i,(function(t){n.info.started&&i(t),ce(n.info)})),this.info.x=t.clientX,this.info.y=t.clientY},touchstart:function(t){let e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove:function(t){let e=he(t),n=t.changedTouches[0],i=n.clientX,o=n.clientY;we(this.info,i,o)&&("start"===this.info.state&&ve("tap"),this.info.addMove({x:i,y:o}),be(this.info,e,n),this.info.state="track",this.info.started=!0)},touchend:function(t){let e=he(t),n=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:n.clientX,y:n.clientY}),be(this.info,e,n))}}),ge({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(t){se(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click:function(t){se(t)&&Se(this.info,t)},touchstart:function(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend:function(t){Se(this.info,t.changedTouches[0],t)}});const xe=function(t){let e=t.__mixinApplications;e||(e=new WeakMap,t.__mixinApplications=e);let n=Mt++;return function(i){let o=i.__mixinSet;if(o&&o[n])return i;let s=e,r=s.get(i);if(!r){r=t(i),s.set(i,r);let e=Object.create(r.__mixinSet||o||null);e[n]=!0,r.__mixinSet=e}return r}}(t=>class extends t{_addEventListenerToNode(t,e,n){fe(t,e,n)||super._addEventListenerToNode(t,e,n)}_removeEventListenerFromNode(t,e,n){me(t,e,n)||super._removeEventListenerFromNode(t,e,n)}});const Pe={required:{icon:"tune",name:"Required",secondary:"Required options for this card to function",show:!0},actions:{icon:"gesture-tap-hold",name:"Actions",secondary:"Perform actions based on tapping/clicking",show:!1,options:{tap:{icon:"gesture-tap",name:"Tap",secondary:"Set the action to perform on tap",show:!1},hold:{icon:"gesture-tap-hold",name:"Hold",secondary:"Set the action to perform on hold",show:!1},double_tap:{icon:"gesture-double-tap",name:"Double Tap",secondary:"Set the action to perform on double tap",show:!1}}},appearance:{icon:"palette",name:"Appearance",secondary:"Customize the name, icon, etc",show:!1}};let Te=class extends it{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get _entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.entity)||""}get _show_warning(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_warning)||!1}get _show_error(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_error)||!1}get _tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.tap_action)||{action:"toggle"}}get _hold_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hold_action)||{action:"none"}}get _double_tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.double_tap_action)||{action:"none"}}render(){if(!this.hass||!this._helpers)return j``;this._helpers.importMoreInfoControl("climate");const t=Object.keys(this.hass.states).filter(t=>"light"===t.substr(0,t.indexOf(".")));return j`
      <div class="card-config">
        ...
        ${Pe.actions.show?j`
              <div class="values">
                ...
                ${Pe.actions.options.hold.show?j`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
                ...
                ${Pe.actions.options.double_tap.show?j`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
    ...
    `}};t([G({attribute:!1})],Te.prototype,"hass",void 0),t([Z()],Te.prototype,"_config",void 0),t([Z()],Te.prototype,"_toggle",void 0),t([Z()],Te.prototype,"_helpers",void 0),Te=t([J("big-slider-card-editor")],Te);var ke={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},Ce={common:ke},Me={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},Ne={common:Me};const Ee={en:Object.freeze({__proto__:null,common:ke,default:Ce}),nb:Object.freeze({__proto__:null,common:Me,default:Ne})};function Oe(t,e="",n=""){const i=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let o;try{o=t.split(".").reduce((t,e)=>t[e],Ee[i])}catch(e){o=t.split(".").reduce((t,e)=>t[e],Ee.en)}return void 0===o&&(o=t.split(".").reduce((t,e)=>t[e],Ee.en)),""!==e&&""!==n&&(o=o.replace(e,n)),o}console.info(`%c  BIG-SLIDER-CARD \n%c  ${Oe("common.version")} 1.3.2    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"big-slider-card",name:"Big Slider Card",description:"A template custom card for you to create something awesome"});let Ae=class extends(xe(it)){constructor(){super(),this.mouseStartPos={x:0,y:0},this.mousePos={x:0,y:0},this.containerWidth=0,this.oldValue=0,this.currentValue=30,this.stateObj=null,this.isHold=!1,this.holdTimer=0,this._setValueThrottled=function(t,e){let n=0;return function(){const i=Date.now();i-n>=e&&(t(),n=i)}}(this._setValue.bind(this),200)}static async getConfigElement(){return document.createElement("big-slider-card-editor")}static getStubConfig(){return{}}connectedCallback(){super.connectedCallback(),this._updateSlider(),fe(this,"down",this._handleDown.bind(this)),fe(this,"up",this._handleUp.bind(this)),fe(this,"tap",this._handleTap.bind(this)),fe(this,"track",this._handleTrack.bind(this)),this.addEventListener("contextmenu",this._handleContextMenu.bind(this))}disconnectedCallback(){me(this,"down",this._handleDown.bind(this)),me(this,"up",this._handleUp.bind(this)),me(this,"tap",this._handleTap.bind(this)),me(this,"track",this._handleTrack.bind(this)),this.removeEventListener("contextmenu",this._handleContextMenu.bind(this)),super.disconnectedCallback()}_handleContextMenu(t){const e=t||window.event;return e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,!1}_handleDown(){var t;this._press(),this.isHold=!1,this.holdTimer=window.setTimeout(this._setHold.bind(this),(null===(t=this.config)||void 0===t?void 0:t.hold_time)||600)}_setHold(){this.isHold=!0,console.log("held!"),Ct(this,this.hass,this.config,!0,!1)}_handleUp(){this._unpress()}_handleTap(){var t;clearTimeout(this.holdTimer),(null===(t=this.config)||void 0===t?void 0:t.tap_action)&&(this.isHold||Ct(this,this.hass,this.config,!1,!1))}_handleTrack(t){switch(this.mousePos={x:t.detail.x,y:t.detail.y},clearTimeout(this.holdTimer),t.detail.state){case"start":this._startTrack();break;case"track":this._track();break;case"end":this._endTrack()}}_startTrack(){this.mouseStartPos={x:this.mousePos.x,y:this.mousePos.y},this.oldValue=this.currentValue,this._press()}_track(){this._updateValue(),this._setValueThrottled()}_endTrack(){this._updateValue(),this._unpress(),this._setValue()}_press(){this.setAttribute("pressed","")}_unpress(){this.removeAttribute("pressed")}_updateValue(){const t=this.containerWidth,e=this.mousePos.x-this.mouseStartPos.x,n=Math.round(100*e/t);this.currentValue=this.oldValue+n,this._checklimits(),this._updateSlider()}_checklimits(){this.currentValue<0&&(this.currentValue=0,this._startTrack()),this.currentValue>100&&(this.currentValue=100,this._startTrack())}_updateSlider(){this.style.setProperty("--bsc-percent",this.currentValue+"%")}_getValue(){var t;if(!this.stateObj)return;const e=(null===(t=this.config)||void 0===t?void 0:t.attribute)||"brightness";let n;if("off"==this.stateObj.state)n=0;else switch(e){case"brightness":n=Math.ceil(100*this.stateObj.attributes.brightness/255);break;case"red":case"green":case"blue":const t=this.stateObj.attributes.rgb_color||[0,0,0];"red"===e&&(n=t[0]),"green"===e&&(n=t[1]),"blue"===e&&(n=t[2]),n=Math.ceil(100*n/255);break;case"hue":case"saturation":const i=this.stateObj.attributes.hs_color||[0,0];"hue"===e&&(n=i[0]),"saturation"===e&&(n=i[1])}console.log("get "+n),this.currentValue=n,this._updateSlider()}_setValue(){var t;let e=this.currentValue;console.log("set "+e);let n,i=(null===(t=this.config)||void 0===t?void 0:t.attribute)||"brightness",o=!0;switch(i){case"brightness":e=Math.ceil(e/100*255),e||(o=!1);break;case"red":case"green":case"blue":n=this.stateObj.attributes.rgb_color||[0,0,0],"red"===i&&(n[0]=e),"green"===i&&(n[1]=e),"blue"===i&&(n[2]=e),e=n,i="rgb_color";break;case"hue":case"saturation":n=this.stateObj.attributes.hs_color||[0,0],"hue"===i&&(n[0]=e),"saturation"===i&&(n[1]=e),e=n,i="hs_color"}o?this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,[i]:e}):this.hass.callService("light","turn_off",{entity_id:this.stateObj.entity_id})}updated(){var t,e;this.containerWidth=(null===(e=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("container"))||void 0===e?void 0:e.clientWidth)||0,this._getValue()}setConfig(t){if(!t)throw new Error(Oe("common.invalid_configuration"));t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({name:"Big Slider"},t)}shouldUpdate(t){return!!this.config&&function(t,e,n){if(e.has("config")||n)return!0;if(t.config.entity){var i=e.get("hass");return!i||i.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1)}render(){var t,e;if((null===(t=this.config)||void 0===t?void 0:t.entity)&&(null===(e=this.config)||void 0===e?void 0:e.entity)in this.hass.states?this.stateObj=this.hass.states[this.config.entity]:this.stateObj=null,null==this.stateObj)return this._showError(Oe("common.show_error"));const n=this.stateObj.attributes&&this.stateObj.attributes.friendly_name?this.stateObj.attributes.friendly_name:(i=this.stateObj.entity_id).substr(i.indexOf(".")+1);var i;return j`
      <ha-card
        id="container"
        tabindex="0"
        >
    ...
    `}};t([G({attribute:!1})],Ae.prototype,"hass",void 0),t([Z()],Ae.prototype,"config",void 0),Ae=t([J("big-slider-card")],Ae);export{Ae as BigSliderCard};
