 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,n,s){const i=e[0];if("."===i){return new M(t,e.slice(1),n).parts}if("@"===i)return[new O(t,e.slice(1),s.eventContext)];if("?"===i)return[new C(t,e.slice(1),n)];return new P(t,e,n).parts}handleTextExpression(t){return new T(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.3.0");const j=(t,...e)=>new b(t,e,"html",U)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Ut=0,jt=0,Rt=[],Yt=0,Lt=!1,Ht=document.createTextNode("");new window.MutationObserver((function(){Lt=!1;const t=Rt.length;for(let e=0;e<t;e++){let t=Rt[e];if(t)try{t()}catch(t){setTimeout(()=>{throw t})}}Rt.splice(0,t),jt+=t})).observe(Ht,{characterData:!0});const It={after:t=>({run:e=>window.setTimeout(e,t),cancel(t){window.clearTimeout(t)}}),run:(t,e)=>window.setTimeout(t,e),cancel(t){window.clearTimeout(t)}},qt={run:t=>(Lt||(Lt=!0,Ht.textContent=Yt++),Rt.push(t),Ut++),cancel(t){const e=t-jt;if(e>=0){if(!Rt[e])throw new Error("invalid async handle: "+t);Rt[e]=null}}};
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
*/xe({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){me(this.info)},mousedown:function(t){if(!ue(t))return;let e=ye(t),n=this;fe(this.info,(function(t){ue(t)||(Te("up",e,t),me(n.info))}),(function(t){ue(t)&&Te("up",e,t),me(n.info)})),Te("down",e,t)},touchstart:function(t){Te("down",ye(t),t.changedTouches[0],t)},touchend:function(t){Te("up",ye(t),t.changedTouches[0],t)}}),xe({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove:function(t){this.moves.length>2&&this.moves.shift(),this.moves.push(t)},movefn:null,upfn:null,prevent:!1},reset:function(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,me(this.info)},mousedown:function(t){if(!ue(t))return;let e=ye(t),n=this,s=function(t){let s=t.clientX,i=t.clientY;Ce(n.info,s,i)&&(n.info.state=n.info.started?"mouseup"===t.type?"end":"track":"start","start"===n.info.state&&ke("tap"),n.info.addMove({x:s,y:i}),ue(t)||(n.info.state="end",me(n.info)),e&&Me(n.info,e,t),n.info.started=!0)};fe(this.info,s,(function(t){n.info.started&&s(t),me(n.info)})),this.info.x=t.clientX,this.info.y=t.clientY},touchstart:function(t){let e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchmove:function(t){let e=ye(t),n=t.changedTouches[0],s=n.clientX,i=n.clientY;Ce(this.info,s,i)&&("start"===this.info.state&&ke("tap"),this.info.addMove({x:s,y:i}),Me(this.info,e,n),this.info.state="track",this.info.started=!0)},touchend:function(t){let e=ye(t),n=t.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:n.clientX,y:n.clientY}),Me(this.info,e,n))}}),xe({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown:function(t){ue(t)&&(this.info.x=t.clientX,this.info.y=t.clientY)},click:function(t){ue(t)&&Ne(this.info,t)},touchstart:function(t){const e=t.changedTouches[0];this.info.x=e.clientX,this.info.y=e.clientY},touchend:function(t){Ne(this.info,t.changedTouches[0],t)}});const Ee=function(t){let e=t.__mixinApplications;e||(e=new WeakMap,t.__mixinApplications=e);let n=$t++;return function(s){let i=s.__mixinSet;if(i&&i[n])return s;let o=e,r=o.get(s);if(!r){r=t(s),o.set(s,r);let e=Object.create(r.__mixinSet||i||null);e[n]=!0,r.__mixinSet=e}return r}}(t=>class extends t{_addEventListenerToNode(t,e,n){be(t,e,n)||super._addEventListenerToNode(t,e,n)}_removeEventListenerFromNode(t,e,n){Se(t,e,n)||super._removeEventListenerFromNode(t,e,n)}});const Oe={required:{icon:"tune",name:"Required",secondary:"Required options for this card to function",show:!0},actions:{icon:"gesture-tap-hold",name:"Actions",secondary:"Perform actions based on tapping/clicking",show:!1,options:{tap:{icon:"gesture-tap",name:"Tap",secondary:"Set the action to perform on tap",show:!1},hold:{icon:"gesture-tap-hold",name:"Hold",secondary:"Set the action to perform on hold",show:!1},double_tap:{icon:"gesture-double-tap",name:"Double Tap",secondary:"Set the action to perform on double tap",show:!1}}},appearance:{icon:"palette",name:"Appearance",secondary:"Customize the name, icon, etc",show:!1}};let Ae=class extends st{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get _entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.entity)||""}get _show_warning(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_warning)||!1}get _show_error(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_error)||!1}get _tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.tap_action)||{action:"toggle"}}get _hold_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hold_action)||{action:"none"}}get _double_tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.double_tap_action)||{action:"none"}}render(){if(!this.hass||!this._helpers)return j``;this._helpers.importMoreInfoControl("climate");const t=Object.keys(this.hass.states).filter(t=>"light"===t.substr(0,t.indexOf(".")));return j`
      <div class="card-config">
        ...
        ${Oe.actions.show?j`
              <div class="values">
                ...
                ${Oe.actions.options.hold.show?j`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
                ...
                ${Oe.actions.options.double_tap.show?j`
                      <div class="values">
                        <paper-item>Action Editors Coming Soon</paper-item>
                      </div>
                    `:""}
    ...
    `}};t([G({attribute:!1})],Ae.prototype,"hass",void 0),t([Z()],Ae.prototype,"_config",void 0),t([Z()],Ae.prototype,"_toggle",void 0),t([Z()],Ae.prototype,"_helpers",void 0),Ae=t([J("big-slider-card-editor")],Ae);var De={version:"Version",invalid_configuration:"Invalid configuration",show_warning:"Show Warning",show_error:"Show Error"},Ve={common:De},$e={version:"Versjon",invalid_configuration:"Ikke gyldig konfiguration",show_warning:"Vis advarsel"},Ue={common:$e};const je={en:Object.freeze({__proto__:null,common:De,default:Ve}),nb:Object.freeze({__proto__:null,common:$e,default:Ue})};function Re(t,e="",n=""){const s=(localStorage.getItem("selectedLanguage")||"en").replace(/['"]+/g,"").replace("-","_");let i;try{i=t.split(".").reduce((t,e)=>t[e],je[s])}catch(e){i=t.split(".").reduce((t,e)=>t[e],je.en)}return void 0===i&&(i=t.split(".").reduce((t,e)=>t[e],je.en)),""!==e&&""!==n&&(i=i.replace(e,n)),i}console.info(`%c  BIG-SLIDER-CARD \n%c  ${Re("common.version")} 1.0.1    `,"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"big-slider-card",name:"Big Slider Card",description:"A template custom card for you to create something awesome"});let Ye=class extends(Ee(st)){constructor(){super(),this.mouseStartPos={x:0,y:0},this.mousePos={x:0,y:0},this.containerWidth=0,this.oldValue=0,this.currentValue=30,this.stateObj=null,this.isHold=!1,this.holdTimer=0,this._shouldUpdate=!0,this.updateTimeout=0,this._setValueThrottled=function(t,e){let n=0;return function(){const s=Date.now();s-n>=e&&(t(),n=s)}}(this._setValue.bind(this),200)}static async getConfigElement(){return document.createElement("big-slider-card-editor")}static getStubConfig(){return{}}connectedCallback(){super.connectedCallback(),this._updateSlider(),be(this,"down",this._handleDown.bind(this)),be(this,"up",this._handleUp.bind(this)),be(this,"tap",this._handleTap.bind(this)),be(this,"track",this._handleTrack.bind(this)),this.addEventListener("contextmenu",this._handleContextMenu.bind(this))}disconnectedCallback(){Se(this,"down",this._handleDown.bind(this)),Se(this,"up",this._handleUp.bind(this)),Se(this,"tap",this._handleTap.bind(this)),Se(this,"track",this._handleTrack.bind(this)),this.removeEventListener("contextmenu",this._handleContextMenu.bind(this)),super.disconnectedCallback()}_handleContextMenu(t){const e=t||window.event;return e.preventDefault&&e.preventDefault(),e.stopPropagation&&e.stopPropagation(),e.cancelBubble=!0,e.returnValue=!1,!1}_handleDown(){var t;this._press(),this.isHold=!1,this.holdTimer=window.setTimeout(this._setHold.bind(this),(null===(t=this.config)||void 0===t?void 0:t.hold_time)||600)}_setHold(){this.isHold=!0,console.log("held!"),At(this,this.hass,this.config,!0,!1)}_handleUp(){this._unpress()}_handleTap(){var t;clearTimeout(this.holdTimer),(null===(t=this.config)||void 0===t?void 0:t.tap_action)&&(this.isHold||At(this,this.hass,this.config,!1,!1))}_handleTrack(t){switch(this.mousePos={x:t.detail.x,y:t.detail.y},clearTimeout(this.holdTimer),t.detail.state){case"start":this._startTrack();break;case"track":this._track();break;case"end":this._endTrack()}}_startTrack(){this.mouseStartPos={x:this.mousePos.x,y:this.mousePos.y},this.oldValue=this.currentValue,this._press(),this._stopUpdates()}_track(){this._updateValue(),this._setValueThrottled()}_endTrack(){this._updateValue(),this._unpress(),this._setValue(),this.updateTimeout&&clearTimeout(this.updateTimeout),this.updateTimeout=window.setTimeout(this._startUpdates.bind(this),2e3)}_press(){this.setAttribute("pressed","")}_unpress(){this.removeAttribute("pressed")}_updateValue(){const t=this.containerWidth,e=this.mousePos.x-this.mouseStartPos.x,n=Math.round(100*e/t);this.currentValue=this.oldValue+n,this._checklimits(),this._updateSlider()}_checklimits(){this.currentValue<0&&(this.currentValue=0,this._startTrack()),this.currentValue>100&&(this.currentValue=100,this._startTrack())}_updateSlider(){this.style.setProperty("--bsc-percent",this.currentValue+"%"),this.style.setProperty("--bsc-icon-color",this._calculateColor())}_getValue(){var t;if(!this.stateObj)return;const e=(null===(t=this.config)||void 0===t?void 0:t.attribute)||"brightness";let n;if("off"==this.stateObj.state)n=0;else switch(e){case"brightness":n=Math.ceil(100*this.stateObj.attributes.brightness/255);break;case"red":case"green":case"blue":const t=this.stateObj.attributes.rgb_color||[0,0,0];"red"===e&&(n=t[0]),"green"===e&&(n=t[1]),"blue"===e&&(n=t[2]),n=Math.ceil(100*n/255);break;case"hue":case"saturation":const s=this.stateObj.attributes.hs_color||[0,0];"hue"===e&&(n=s[0]),"saturation"===e&&(n=s[1])}console.log("get "+n),this.currentValue=n,this._updateSlider()}_setValue(){var t;let e=this.currentValue;console.log("set "+e);let n,s=(null===(t=this.config)||void 0===t?void 0:t.attribute)||"brightness",i=!0;switch(s){case"brightness":e=Math.ceil(e/100*255),e||(i=!1);break;case"red":case"green":case"blue":n=this.stateObj.attributes.rgb_color||[0,0,0],"red"===s&&(n[0]=e),"green"===s&&(n[1]=e),"blue"===s&&(n[2]=e),e=n,s="rgb_color";break;case"hue":case"saturation":n=this.stateObj.attributes.hs_color||[0,0],"hue"===s&&(n[0]=e),"saturation"===s&&(n[1]=e),e=n,s="hs_color"}i?this.hass.callService("light","turn_on",{entity_id:this.stateObj.entity_id,[s]:e}):this.hass.callService("light","turn_off",{entity_id:this.stateObj.entity_id})}setConfig(t){if(!t)throw new Error(Re("common.invalid_configuration"));t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({name:"Big Slider"},t)}_stopUpdates(){var t,e,n;this._shouldUpdate=!1,null===(n=null===(e=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("slider"))||void 0===e?void 0:e.classList)||void 0===n||n.remove("animate"),console.log("Should Update: "+this._shouldUpdate)}_startUpdates(){var t,e,n;this._shouldUpdate=!0,null===(n=null===(e=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("slider"))||void 0===e?void 0:e.classList)||void 0===n||n.add("animate"),console.log("Should Update: "+this._shouldUpdate),this.requestUpdate()}_calculateColor(){let t="var(--bsc-color)";const e=this.stateObj;if(e){if("on"==e.state){const n=e.attributes.rgb_color;n&&(t=`rgb(${n.join(",")})`)}"off"==e.state&&(t="var(--bsc-off-color)")}return t}shouldUpdate(t){return!!this.config&&(this._shouldUpdate&&function(t,e,n){if(e.has("config")||n)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1))}updated(){var t,e;this.containerWidth=(null===(e=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("container"))||void 0===e?void 0:e.clientWidth)||0,this._getValue()}render(){var t,e;if(!(null===(t=this.config)||void 0===t?void 0:t.entity)||!((null===(e=this.config)||void 0===e?void 0:e.entity)in this.hass.states))return this.stateObj=null,this._showError(Re("common.show_error"));this.stateObj=this.hass.states[this.config.entity];const n=this.stateObj.attributes&&this.stateObj.attributes.friendly_name?this.stateObj.attributes.friendly_name:(s=this.stateObj.entity_id).substr(s.indexOf(".")+1);var s;const i=function(t){if(!t)return kt;if(t.attributes.icon)return t.attributes.icon;var e=Pt(t.entity_id);return e in Vt?Vt[e](t):Nt(e,t.state)}(this.stateObj);return console.log("Render!"),j`
      <ha-card
        id="container"
        tabindex="0"
        >
    ...
    `}_showWarning(t){return j`
      <hui-warning>${t}</hui-warning>
    `}_showError(t){const e=document.createElement("hui-error-card");return e.setConfig({type:"error",error:t,origConfig:this.config}),j`
      ${e}
