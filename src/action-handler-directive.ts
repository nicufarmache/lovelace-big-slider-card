...
customElements.define('action-handler-big-slider', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-big-slider')) {
    return body.querySelector('action-handler-big-slider') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-big-slider');
